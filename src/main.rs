...
/*     let (_stream, stream_handle) = OutputStream::try_default().unwrap();
    ...
    let linedefs = vec![
        Linedef { start: vertices[0], end: vertices[1], height: 1.0, floor_level: 0.0, texture: TextureId::BrickWalls, wrap_texture: true },
        Linedef { start: vertices[1], end: vertices[2], height: 2.0, floor_level: 0.0, texture: TextureId::RedBricks, wrap_texture: true },
        Linedef { start: vertices[2], end: vertices[3], height: 2.0, floor_level: 0.0, texture: TextureId::CorrodedCooperWall, wrap_texture: true },
        Linedef { start: vertices[3], end: vertices[4], height: 1.0, floor_level: 0.0, texture: TextureId::BrickWalls, wrap_texture: true },
        Linedef { start: vertices[4], end: vertices[5], height: 2.0, floor_level: 0.0, texture: TextureId::RedBricks, wrap_texture: true },
        Linedef { start: vertices[5], end: vertices[6], height: 2.0, floor_level: 0.0, texture: TextureId::CorrodedCooperWall, wrap_texture: true },
        Linedef { start: vertices[6], end: vertices[7], height: 1.0, floor_level: 0.0, texture: TextureId::BrickWalls, wrap_texture: true },
        Linedef { start: vertices[7], end: vertices[8], height: 3.0, floor_level: 0.0, texture: TextureId::RedBricks, wrap_texture: true },
        Linedef { start: vertices[8], end: vertices[9], height: 2.0, floor_level: 0.0, texture: TextureId::CorrodedCooperWall, wrap_texture: true },
        Linedef { start: vertices[9], end: vertices[10], height: 1.0, floor_level: 0.0, texture: TextureId::BrickWalls, wrap_texture: true },
        Linedef { start: vertices[10], end: vertices[11], height: 2.0, floor_level: 0.0, texture: TextureId::RedBricks, wrap_texture: true },
        Linedef { start: vertices[11], end: vertices[0], height: 2.0, floor_level: 0.0, texture: TextureId::BrickWalls, wrap_texture: true },
